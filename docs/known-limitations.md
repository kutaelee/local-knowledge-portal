...
- Full deletion/rename reconciliation, append-only log offsets, link/tag extraction, generated wiki pages, and optional read-only MCP adapter remain incomplete.
...
- Windows Scheduled Task installation is not included.
